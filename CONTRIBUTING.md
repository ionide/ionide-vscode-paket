...
Fork, from the github interface https://github.com/ionide/ionide-vscode-paket
 - if you don't use a certificate for committing to github:
```bash
git clone https://github.com/YOUR_GITHUB_USER/ionide-vscode-paket.git
```
 - if you use a certificate for github authentication:
```bash
git clone git@github.com:YOUR_GITHUB_USER/ionide-vscode-paket.git
```

#### First time build:
```bash
cd ionide-vscode-paket
